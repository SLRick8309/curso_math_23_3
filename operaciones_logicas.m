...
% AND Es una operacion cuyo resultado es 1, si ambos valores que se
% combinan son 1, de lo contrario son 0

% OR Es una operacion donde el resultado es 1, si alguno de los 2 valores
% es 1
